...
void generate_keys(const std::vector<uint8_t>& key) {
    ...
    if (key_lenght == 128) {
        ...
        k[6] = high128(KAL, KAR, 30);
        k[7] = low128(KAL, KAR, 30);
        k[8] = high128(KLL, KLR, 45);
        k[9] = low128(KLL, KLR, 45);
        k[10] = high128(KAL, KAR, 45);
        k[11] = low128(KAL, KAR, 45);
        kl[0] = high128(KLL, KLR, 60);
        kl[1] = low128(KLL, KLR, 60);
        k[12] = high128(KAL, KAR, 60);
        k[13] = low128(KAL, KAR, 60);
        k[14] = high128(KLL, KLR, 77);
        k[15] = low128(KLL, KLR, 77);
        k[16] = high128(KLL, KLR, 94);
        k[17] = low128(KLL, KLR, 94);
